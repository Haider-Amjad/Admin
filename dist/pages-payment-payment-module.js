...
var NgxSpinnerService = /** @class */ (function () {
    ...
    */
    ...
    /** @nocollapse */ NgxSpinnerService.ngInjectableDef = Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["defineInjectable"])({ factory: function NgxSpinnerService_Factory() { return new NgxSpinnerService(); }, token: NgxSpinnerService, providedIn: "root" });
...
var NgxSpinnerComponent = /** @class */ (function () {
    ...
    NgxSpinnerComponent.propDecorators = {
        bdColor: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Input"] }],
...
/* harmony import */ var _paypal_paypal_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./paypal/paypal.component */ "./src/app/pages/payment/paypal/paypal.component.ts");
...
var routes = [
    {
        ...
        children: [
            {
                path: 'paypal/:id',
                component: _paypal_paypal_component__WEBPACK_IMPORTED_MODULE_2__["PaypalComponent"]
            }
        ]
    }
];
...
/* harmony import */ var _payment_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./payment-routing.module */ "./src/app/pages/payment/payment-routing.module.ts");
/* harmony import */ var _paypal_paypal_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./paypal/paypal.component */ "./src/app/pages/payment/paypal/paypal.component.ts");
...
var PaymentModule = /** @class */ (function () {
    ...
    PaymentModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [_paypal_paypal_component__WEBPACK_IMPORTED_MODULE_3__["PaypalComponent"]],
            imports: [
...
/***/ "./src/app/pages/payment/paypal/paypal.component.html":
/*!************************************************************!*\
  !*** ./src/app/pages/payment/paypal/paypal.component.html ***!
  \************************************************************/
...
module.exports = "<div >\n    <ngx-spinner\n    bdColor=\"rgba(51,51,51,0.8)\"\n    size=\"medium\"\n    color=\"#fff\"\n    type=\"ball-scale-multiple\">\n    <p style=\"font-size: 20px; color: white\">{{spinnerText}}</p>\n    </ngx-spinner>\n</div>\n<div class=\"container-fluid\">\n  <!--login page start-->\n  <div class=\"authentication-main\">\n      \n    <div class=\"row\">\n\n      <div class=\"col-md-12 p-0\">\n        <div class=\"auth-innerright\">\n          <div class=\"authentication-box\">\n              <!-- <div class=\"col-md-12\">\n                  <img style=\"width: 180px; height: 180px; margin-bottom: 20px\" src=\"assets/images/logo-light.png\" alt=\"Digital Dairy\">\n              </div> -->\n            <h4>SPORT-X - Order Payment</h4>\n            \n            <div>\n                <h5 *ngIf=\"paymentStatus != null\">Booking Type: {{orderData.bookingType}}</h5>\n                <h5 *ngIf=\"paymentStatus != null\">Booking Date: {{orderData.date}}</h5>\n                <h5 *ngIf=\"paymentStatus != null\">Booking Time: {{orderData.time}} </h5>\n                <h5 *ngIf=\"paymentStatus != null\">Booking Price(USD): {{usdPrice}} </h5>\n                <h5 *ngIf=\"paymentStatus != null\" style=\"color:#5E7606\">Payment Status: {{paymentStatus}}</h5>\n                <h5 *ngIf=\"paymentStatus == paid\">You have successfully made the payment for this order!!</h5>\n                <h5 *ngIf=\"invalidOrderIdText == 'invalid'\">Invalid Order ID</h5>\n                <hr >\n                <h6 *ngIf=\"paymentStatus == 'pending' && paymentStatus != null\">Click on the Paypal Icon Below to Pay for you Order (if icon dosen't until 30 seconds kindly swipe down to refresh screen)</h6>\n            </div>\n               \n      \n          <div class=\"row\" style=\"margin-top: 20px;\">\n            \n            <!-- <div class=\"col-md-1\"></div> -->\n            \n            <div class=\"col-md-12\">\n              <div id=\"paypal-checkout-btn\"></div>\n            </div>\n            \n            <!-- <div class=\"col-md-1\"></div> -->\n          \n          </div>\n\n\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n\n\n\n  <!--login page end-->\n</div>\n"

/***/ }),

/***/ "./src/app/pages/payment/paypal/paypal.component.scss":
/*!************************************************************!*\
  !*** ./src/app/pages/payment/paypal/paypal.component.scss ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL3BheW1lbnQvcGF5cGFsL3BheXBhbC5jb21wb25lbnQuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/pages/payment/paypal/paypal.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/pages/payment/paypal/paypal.component.ts ***!
  \**********************************************************/
...
/* harmony import */ var _services_helper_helper_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../services/helper/helper.service */ "./src/app/services/helper/helper.service.ts");
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-spinner */ "./node_modules/ngx-spinner/fesm5/ngx-spinner.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var PaypalComponent = /** @class */ (function () {
    function PaypalComponent(toastrService, router, route, api, spinner, helper) {
    ...
    PaypalComponent.prototype.getOrderData = function () {
        var _this = this;
        this.spinner.show();
        this.spinnerText = 'Fetching Details.. Please wait';
        this.api.get('bookingdetails/get_bookingDetailById/' + this.bookingId).then(function (response) {
            _this.orderData = response;
            _this.paymentStatus = _this.orderData.paymentStatus;
            _this.usdPrice = _this.orderData.price;
            console.log("orderData" + _this.orderData.paymentStatus);
            if (_this.orderData.paymentStatus == "pending") {
                _this.paymentOption();
            }
            _this.spinner.hide();
        }, function () {
            _this.invalidOrderIdText = "invalid";
            _this.spinner.hide();
            _this.helper.failureBigToast('Failed!', 'Order ID is invalid');
        });
    };
    ...
    //   });
    // }
    PaypalComponent.prototype.sendUpdateRequest = function (data) {
        var _this = this;
        console.log("Req", data);
        this.api.patch('bookingdetails/update_bookingDetails/', this.bookingId, data).then(function (response) {
            _this.helper.successBigToast('Success', 'Successfully Paid for the Order');
            // setTimeout(() => 
            // {
            ...
            _this.helper.failureBigToast('Failed!', 'Kindly try again');
        });
    };
    // Paypal Code
    ...
    PaypalComponent.prototype.paymentOption = function () {
        var _this = this;
        if (true) {
            if (!this.addScript) {
                this.addPaypalScript().then(function () {
                    paypal.Button.render(_this.paypalConfigg, '#paypal-checkout-btn');
                    ...
                    return actions.payment.create({
                        payment: {
                            transactions: [
                                ...
                                { amount: { total: _this.usdPrice, currency: 'USD' } }
                            ]
                        }
                    });
                },
                onAuthorize: function (data, actions) {
                    actions.order.get().then(function (details) {
                        ...
                        if (details.status == "APPROVED") {
                            ...
                            _this.paymentStatus = "paid";
                            var paymentData = {
                                paymentStatus: 'paid',
                                state: 'accepted'
                            };
                            _this.toastrService.success("We have Successfully Processed your Payment", "Thank you!!");
                            $('#paypal-checkout-btn').hide();
                            $('#payment-text').hide();
                            $('#payment-icon').hide();
                            _this.sendUpdateRequest(paymentData);
                        }
                        else {
                            _this.toastrService.error("There was an error in processing your Payment", "Warning");
                        }
                    });
                },
            };
    ...
    PaypalComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-paypal',
            template: __webpack_require__(/*! ./paypal.component.html */ "./src/app/pages/payment/paypal/paypal.component.html"),
            styles: [__webpack_require__(/*! ./paypal.component.scss */ "./src/app/pages/payment/paypal/paypal.component.scss")]
        }),
        __metadata("design:paramtypes", [ngx_toastr__WEBPACK_IMPORTED_MODULE_2__["ToastrService"],
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
            _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"],
            _services_api_rest_api_service__WEBPACK_IMPORTED_MODULE_1__["RestApiService"],
            ngx_spinner__WEBPACK_IMPORTED_MODULE_5__["NgxSpinnerService"],
            _services_helper_helper_service__WEBPACK_IMPORTED_MODULE_4__["HelperService"]])
    ], PaypalComponent);
